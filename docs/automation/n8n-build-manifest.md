...
- **Current build status:** this node is the CEO-authorized callback normalizer inserted between the Telegram Trigger and Node 1b; its output is intentionally restricted to the three approved in-flight fields only.
