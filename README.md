...
- **Live verified (Telegram backend, primary verified product channel):** the n8n workflow (`"My workflow 2"`, ID `gXPlaislJyNuqJSd`) runs the full five-question guided flow, gives a grounded/source-cited final answer, routes correctly to the escalation fallback on sensitive input, switches language mid-conversation, sends a real reminder on request ("remind me", 2-minute delay), and delivers cleanly to Telegram — tested 2026-09-16 and 2026-09-17 (reminder: n8n execution #23), and used successfully by a real informal trial contact (a social worker) on 2026-09-17. Public link: `https://t.me/MUKKUM13_BOT`. The workflow is kept **unpublished** between authorized, controlled tests.
...
- **Live verified ABSENT:** anonymised Google Sheets logging (D2.3) does not exist — explicitly deferred by CEO decision.
...
- No Google Sheets logging (D2.3) exists — explicitly deferred by CEO decision, not a hidden failure. The Telegram reminder module (D2.4) is now built and live-verified (see Status above).
